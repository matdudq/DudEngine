...
namespace dud {
void CameraComponent::SetOrthographicProjection(float left,
												float right,
												float top,
												float bottom,
												float near,
...
void CameraComponent::SetViewDirection(glm::vec3 position,
									   glm::vec3 direction,
									   glm::vec3 up) {
...
void CameraComponent::SetViewTarget(glm::vec3 position,
									glm::vec3 target,
									glm::vec3 up) {
