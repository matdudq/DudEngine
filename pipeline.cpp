...
Pipeline::Pipeline(Device &device,
				   ...
				   const std::string &fragmentShaderPath) : device(device) {
...
void Pipeline::CreateGraphicsPipeline(const std::string &vertexShaderPath,
  ...
  std::cout << "Vertex Shader Code Size: " << vertexShader.size() << "\n";
  std::cout << "Fragment Shader Code Size: " << fragmentShader.size() << "\n";
  ...
  API_CALL_VALIDATE(vkCreateGraphicsPipelines(device.GetDevice(),
											  VK_NULL_HANDLE,
											  1,
											  &pipelineCreateInfo,
											  nullptr,
...
void Pipeline::CreateShaderModule(const std::vector<char> &code,
  ...
  API_CALL_VALIDATE(vkCreateShaderModule(device.GetDevice(),
										 &createInfo,
										 nullptr,
										 shaderModule));
}
