...
// class member functions
    ...
    void DudDevice::createInstance() {
        ...
        API_CALL_VALIDATE(vkCreateInstance(&createInfo, nullptr, &instance));
    ...
    void DudDevice::createLogicalDevice() {
        ...
        API_CALL_VALIDATE(vkCreateDevice(physicalDevice, &createInfo, nullptr, &device_));
    ...
    void DudDevice::createBuffer(
        ...
        API_CALL_VALIDATE(vkCreateBuffer(device_, &bufferInfo, nullptr, &buffer));
        ...
        API_CALL_VALIDATE(vkAllocateMemory(device_, &allocInfo, nullptr, &bufferMemory));
    ...
    void DudDevice::createImageWithInfo(
        ...
        API_CALL_VALIDATE(vkCreateImage(device_, &imageInfo, nullptr, &image));
        ...
        API_CALL_VALIDATE(vkAllocateMemory(device_, &allocInfo, nullptr, &imageMemory));
        API_CALL_VALIDATE(vkBindImageMemory(device_, image, imageMemory, 0));
    }
